...
namespace ¼××´ÏÙËæ·ÃÏµÍ³
{
    public partial class PatientInfoFiltering : Office2007Form
    {
        ...
        public void getPatientInfoTable() {
            ...
            DataRelation dr = new DataRelation("Ëæ·Ã", ds.Tables["tb_patientInfo"].Columns["±àºÅ×ÔÔö"], ds.Tables["tb_visit"].Columns["»¼Õß±àºÅ"], false);
            DataRelation dr2 = new DataRelation("µâÖÎÁÆ", ds.Tables["tb_patientInfo"].Columns["±àºÅ×ÔÔö"], ds.Tables["tb_radioactiveIodine"].Columns["»¼Õß±àºÅ"], false);
            DataRelation dr3 = new DataRelation("Êõºó¼ì²é", ds.Tables["tb_patientInfo"].Columns["±àºÅ×ÔÔö"], ds.Tables["tb_inspectionAfterSurgery"].Columns["»¼Õß±àºÅ"], false);
            ds.Relations.Add(dr);
