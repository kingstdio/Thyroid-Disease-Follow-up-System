            ...
            if ((!string.IsNullOrEmpty(bi.name) && !string.IsNullOrWhiteSpace(bi.name)) && ((!string.IsNullOrEmpty(bi.idcard) && !string.IsNullOrWhiteSpace(bi.idcard))))
            {
                if (pid == 0)
                {
                    try
                    {
                        ...
                        //患者基本信息
                        string sql = "insert into tb_patientInfo values ('" + bi.name + "','" + bi.idcard + "','" + bi.studynum + "','" + bi.address + "','" + bi.mobile + "','" + bi.phone + "','" + bi.email + "','" + bi.wechat + "','" + bi.hosnumber + "','" + bi.sex + "','" + bi.birthday + "','" + bi.hosage + "','" + bi.hosindate + "','" + bi.hosoutdate + "','" + nrf.resident + "','" + nrf.menophaniaage + "','" + nrf.pregnancyage + "','" + nrf.pregnancytimes + "','" + nrf.abortiontimes + "','" + nrf.deliverytimes + "','" + nrf.menopause + "','" + nrf.lastmenstr + "','" + nrf.smoke + "','" + nrf.drink + "','" + nrf.occupation + "','" + nrf.height + "','" + nrf.weight + "','" + nrf.constitutional + "','" + srf.prolactin + "','" + srf.estradiol + "','" + srf.pregnendione + "','" + srf.testosterone + "','" + srf.luteinizing + "','" + srf.folliclestimulating + "','" + srf.cholesterol + "','" + srf.llipoprotein + "','" + srf.hlipoprotein + "','" + srf.triglyceride + "','" + srf.bloodGlucose + "','" + fh.hypertension + "','" + fh.diabetes + "','" + fh.coronary + "','" + fh.radiotherapy + "','" + fh.otherntumour + "','" + fh.otherntumourtext + "','" + fh.otherptumour + "','" + fh.othernoptumourtext + "','" + fh.familyhistory + "','" + fh.familyhistorytext + "');select @@identity";
                        ...
                        //诊断
                        string sqlD = "insert into tb_diagnosis values ('" + currentID + "','" + ie.tirads + "','" + ie.part + "','" + ie.tdlymphnodemetastisis + "','" + ie.remark + "','" + ie.ucthyroidcancer + "','" + ie.elasticimpactrating + "','" + ie.ctthyroidcancer + "','" + ie.ctlymphnodemetastisis + "','" + ie.laryngoscope + "','" + ie.diagnosis + "','" + hie.Bethesda + "','" + hie.thyroidbraf + "','" + hie.thyroidRAS + "','" + hie.thyroidTERT + "','" + hie.thyroidPTC1 + "','" + hie.thyroidPTC3 + "','" + hie.thyroidPAX8 + "','" + hie.lymphnodesFNA + "','" + hie.lymphnodesbraf + "','" + hie.lymphnodestg + "','" + he.TSH + "','" + he.ATG + "','" + he.CT + "','" + he.FT3 + "','" + he.ATPO + "','" + he.TG + "','" + he.FT4 + "','" + he.PTH + "','" + he.CEA + "','" + he.K + "','" + he.Ca + "','" + he.Na + "','" + he.P + "','" + he.Cl + "','" + he.uI + "')";
                        SQLHELPER.ExecuteNoneQuery(sqlD);

                        //手术史
                        string sqlSH = "insert into tb_surgeryHistory values ('" + currentID + "','" + boi.surgerytime + "','" + boi.surgerytype + "','" + boi.surgeryfrequency + "','" + boi.doctor + "','" + boi.leftlobe + "','" + boi.rightlobe + "','" + boi.leftVI + "','" + boi.rightVI + "','" + boi.leftneck + "','" + boi.rightneck + "','" + boi.ROTCOthers + "','" + dtc.PCmaxtumordiameter + "','" + dtc.PCalltumordiameter + "','" + dtc.PCalltumorrange + "','" + dtc.PCall2 + "','" + dtc.PCmulifocality + "','" + dtc.PCbilateralcancer + "','" + dtc.PCcapsuleinvasion + "','" + dtc.PClymphaticmetastasis + "','" + dtc.PClymphocyticthyroiditis + "','" + dtc.PChypotype + "','" + dtc.FCmaxtumordiameter + "','" + dtc.FCalltumordiameter + "','" + dtc.FCalltumorrange + "','" + dtc.FCall2 + "','" + dtc.FCmulifocality + "','" + dtc.FCbilateralcancer + "','" + dtc.FCcapsuleinvasion + "','" + dtc.FClymphaticmetastasis + "','" + dtc.FClymphocyticthyroiditis + "','" + dtc.MCmaxtumordiameter + "','" + dtc.MCalltumordiameter + "','" + dtc.MCalltumorrange + "','" + dtc.MCall2 + "','" + dtc.MCmulifocality + "','" + dtc.MCbilateralcancer + "','" + dtc.MCcapsuleinvasion + "','" + dtc.MClymphaticmetastasis + "','" + dtc.MClymphocyticthyroiditis + "','" + dtc.MChypotype + "','" + lm.Ileftn + "','" + lm.Ileftd + "','" + lm.Irightn + "','" + lm.Irightd + "','" + lm.IIleftn + "','" + lm.IIleftd + "','" + lm.IIrightn + "','" + lm.IIrightd + "','" + lm.IIIleftn + "','" + lm.IIIleftd + "','" + lm.IIIrightn + "','" + lm.IIIrightd + "','" + lm.IVleftn + "','" + lm.IVleftd + "','" + lm.IVrightn + "','" + lm.IVrightd + "','" + lm.Vleftn + "','" + lm.Vleftd + "','" + lm.Vrightn + "','" + lm.Vrightd + "','" + lm.VIleftn + "','" + lm.VIleftd + "','" + lm.VIrightn + "','" + lm.VIrightd + "','" + lm.VIsumn + "','" + lm.VIsumd + "','" + lm.prelaryngealn + "','" + lm.prelaryngeald + "','" + lm.region + "','" + lm.regionleftn + "','" + lm.regionleftd + "','" + lm.regionrightn + "','" + lm.regionrightd + "','" + lm.carbonnano + "','" + lm.primarytumors + "','" + lm.RLNM + "','" + lm.distantmetastasis + "','" + lm.PTNM + "','" + lm.nerveMonitor + "','" + lm.V1 + "','" + lm.V2 + "','" + lm.R1 + "','" + lm.R2 + "','" + otc.otherthyroidcancer + "','" + otc.melecularneuropathology + "','" + otc.TGT + "','" + otc.CK + "','" + otc.CK19 + "','" + otc.CD151 + "','" + otc.galecins3 + "','" + otc.calctionin + "','" + otc.braf + "','" + otc.Ki67 + "','" + otc.cyclinD1 + "','" + otc.HBME1 + "','" + otc.TTF1 + "','" + otc.VEGF + "','" + otc.others + "')";
                        SQLHELPER.ExecuteNoneQuery(sqlSH);
                        Console.WriteLine(dtc.MChypotype);

                        //术后
                        string sqlPO = "insert into tb_postOperative values('" + currentID + "','" + t.euthyrox + "','" + t.chemotherapy + "','" + t.radiotherapy + "','" + c.hoarseness + "','" + c.dyspnea + "','" + c.drinkchok + "','" + c.hyperspasmia + "','" + c.galactorrhea + "','" + c.infection + "','" + c.Bparalysis + "','" + c.Bhypomotility + "','" + c.PLparalysis + "','" + c.PLhypomotility + "','" + c.VocalChange + "','" + c.bleed + "','" + c.numb + "')";
                        ...
                        //复发
                        string sqlRe = "insert into tb_recurrencecs values('" + currentID + "','" + re.recurrent + "','" + re.TG + "','" + re.TGAB + "','" + re.CEA + "','" + re.calcitonin + "','" + re.CT + "','" + re.MRI + "','" + re.I131 + "','" + re.PETCT + "','" + re.FNA + "','" + re.braf + "','" + re.TGeluant + "','" + re.tumorlocation + "','" + re.tumorsize + "','" + re.lymphadenlocation + "','" + re.lymphadensize + "')";
                ...
                else
                {
                    try
                    {
                        ...
                        //复发
                        string sqlReU = "update tb_recurrencecs set pid = '" + pid + "',recurrent = '" + re.recurrent + "',TG = '" + re.TG + "',TGAB = '" + re.TGAB + "',CEA = '" + re.CEA + "',calcitonin = '" + re.calcitonin + "',CT = '" + re.CT + "',MRI = '" + re.MRI + "',I131 = '" + re.I131 + "',PETCT = '" + re.PETCT + "',FNA = '" + re.FNA + "',braf = '" + re.braf + "',TGeluant = '" + re.TGeluant + "',tumorlocation = '" + re.tumorlocation + "',tumorsize = '" + re.tumorsize + "',lymphadenlocation = '" + re.lymphadenlocation + "',lymphadensize = '" + re.lymphadensize + "'where pid = @id";
