...
namespace 甲状腺随访系统.DAO
{
    public class PatientInfo
    {
        ...
        s.PCalltumordiameter as '所有肿瘤直径和',
        s.PCalltumorrange as '所有肿瘤直径范围',
        s.PCmulifocality as '多灶性',
        s.PCbilateralcancer as '双侧癌',
        s.PCcapsuleinvasion as '被膜侵犯',
        s.PClymphaticmetastasis as '淋巴结转移',
        s.PClymphocyticthyroiditis as '伴淋巴细胞甲状腺炎',
        s.PChypotype as '亚型',
        s.FCmaxtumordiameter as '（滤泡性癌）最大肿瘤直径',
        s.FCalltumordiameter as '所有肿瘤直径和',
        s.FCalltumorrange as '所有肿瘤直径范围',
        s.FCmulifocality as '多灶性',
        s.FCbilateralcancer as '双侧癌',
        s.FCcapsuleinvasion as '被膜侵犯',
        s.FClymphaticmetastasis as '淋巴结转移',
        s.FClymphocyticthyroiditis as '伴淋巴细胞甲状腺炎',
        s.Ileftn as 'I区左',
        s.Ileftd as ' ',
        s.Irightn as 'I区右',
        s.Irightd as ' ',
